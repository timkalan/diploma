...
\newcommand{\imementorja}{izred.~prof.~dr. Marjetka Knez} % akademski naziv in ime mentorja
\newcommand{\naslovdela}{Spodbujevano učenje pri igranju namiznih iger}
...
{\bf Ključne besede:} Spodbujevano učenje  \\[1mm]  
...
Edgar Allan Poe in maelzel's chess player 
“If we choose to call the former [Chess-Player] a pure machine we must be prepared to admit that 
...
Spodbujevano učenje ima zelo lepo motivacijo, in sicer izhaja iz psihologije. Znana psihologa 
...
logično razmišljanje. Vseeno pa je to motiviralo utemeljitelje (pač povej kdo so to ane) 
spodbujevanega učenja
...
\begin{itemize}
    ...
    \item \textbf{Spodbujevano učenje} se ukvarja z ">učenjem iz izkušenj."< 
\end{itemize}

\subsection{Struktura naloge}
V prvem poglavju bla bla
...
\section{Spodbujevano učenje pri namiznih igrah}
