...
nekaj rezultatov, do katerih smo prišli. Program je napisan v programskem jeziku \textit{Python}. 
Vsa koda je prosto dostopna na \href{https://github.com/timkalan/diploma}{Githubu}.
...
\subsection{Kaj smo raziskovali?}
...
Uporabili smo prej omenjeno vrednostno funkcijo po-stanj in jo predstavili kot slovar v Pythonu. 

\subsection{Agent s funkcijsko aproksimacijo}
\subsubsection{Hiperparametri in arhitektura}
