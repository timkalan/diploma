...
se posvetimo še funkcijski aproksimaciji in kombinaciji nevronskih mrež s spoznanimi algoritmi.
...
The motivation for this work is trying to undertand algorithms that learn through trial and error. 
At the beginning we set the theoretical foundation by examining Markov decision processes. We then 
derive and describe methods for solving them, which are based on dynamic programming. Further we
